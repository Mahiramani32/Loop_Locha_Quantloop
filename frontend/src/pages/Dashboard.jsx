...
const Dashboard = () => {
  ...
  const loadStories = () => {
    const savedStories = JSON.parse(localStorage.getItem('stories') || '[]')
    setStories(savedStories.length ? savedStories : [
      { id: 1, title: 'Echoes from the Nebula', date: '2024-03-15', score: 95, preview: 'In the depths of space, a mysterious signal...', fullStory: 'In the depths of space, a mysterious signal was detected...' },
      { id: 2, title: 'The Last Lighthouse', date: '2024-03-14', score: 82, preview: 'On a rocky shore, the old lighthouse keeper...', fullStory: 'On a rocky shore, the old lighthouse keeper spent his days watching the waves...' },
      { id: 3, title: 'Whispers in the Wind', date: '2024-03-13', score: 78, preview: 'The wind carried secrets through the valley...', fullStory: 'The wind carried secrets through the valley, whispering tales of old...' },
      { id: 4, title: 'Digital Dreams', date: '2024-03-12', score: 88, preview: 'In a world of virtual reality, one programmer...', fullStory: 'In a world of virtual reality, one programmer discovered something unexpected...' },
      { id: 5, title: 'The Forgotten Temple', date: '2024-03-11', score: 91, preview: 'Deep in the jungle, an ancient temple held...', fullStory: 'Deep in the jungle, an ancient temple held secrets that could change history...' },
      { id: 6, title: 'Midnight Melody', date: '2024-03-10', score: 85, preview: 'Every night at midnight, a mysterious piano...', fullStory: 'Every night at midnight, a mysterious piano played music that haunted the town...' },
    ])
  }
