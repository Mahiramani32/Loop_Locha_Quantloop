...
//             <p className="text-3xl font-bold text-purple-600 dark:text-purple-400">Echoes from the Nebula</p>
//             <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">95% score</p>
//           </div>
//         </div>
