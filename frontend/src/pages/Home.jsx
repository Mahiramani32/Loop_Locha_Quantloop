...
//       emoji: '❤️',
//       story: 'Sarah never believed in love at first sight until she walked into the old bookstore and saw him reading her favorite novel. Their eyes met, and time stood still...'
//     },
//     {
//       title: 'Sci-Fi',
//       desc: 'Intergalactic adventure',
//       emoji: '🚀',
//       story: "Captain Ray's ship was caught in a cosmic storm when an alien vessel emerged from the vortex. First contact was about to begin, and humanity wasn't ready..."
//     }
//   ]
...
const Home = () => {
  ...
  // Subtle snowfall effect with tiny balls
  useEffect(() => {
    const createSnowflake = () => {
      const snowflake = {
        id: Math.random(),
        left: Math.random() * 100,
        animationDuration: 5 + Math.random() * 8, // Slower
        opacity: 0.1 + Math.random() * 0.3, // Very subtle
        size: 2 + Math.random() * 4 // Tiny balls (2-6px)
      }
    ...
    // Create fewer snowflakes (every 500ms instead of 300ms)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300 relative overflow-hidden">
      ...
      {/* Subtle Snowfall Effect - Tiny White Balls */}
